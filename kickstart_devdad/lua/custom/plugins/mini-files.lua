...
local mini_files_km = require 'custom.modules.mini-files-km'

-- -- git config is slowing mini.files too much, so disabling it
local mini_files_git = require 'custom.modules.mini-files-git'
...
return {
  ...
  opts = function(_, opts)
    ...
    opts.mappings = vim.tbl_deep_extend('force', opts.mappings or {}, {
      -- closes the mini files explorer but this is annoying to reach to so change it to q
      close = 'q',
