...
;; Match comment color to Tomorrow Night palette (only when that theme is active)
...
;; (setq doom-font (font-spec :family "JetBrainsMono Nerd Font Mono" :size 17 :weight 'medium)
