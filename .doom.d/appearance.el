...
;; --- startup theme load ---
;; Prefer the theme generated by i3/generate.sh so Emacs matches the
;; active i3 theme on startup; fall back to doom-tomorrow-night.
(let ((theme-file (expand-file-name "~/.config/dotfiles/emacs/theme.el")))
