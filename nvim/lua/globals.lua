...
_G.tools.get_path_root = function(path)
...
_G.tools.get_git_remote_name = function(root)
...
function _G.tools.get_git_branch(root)
  if not root then return nil end
  ...
  if out == "HEAD" then
    ...
    commit = _G.tools.hl_str("Comment", "(" .. commit .. ")")
...
-- LSP -----------------------------
_G.tools.diagnostics_available = function()
